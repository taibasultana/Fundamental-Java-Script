...
var myBudget = 95000;
// if iphone is less than my budget. I will buy the iphone
/**
 * if iphone is less than my budget
...
if ( chickenPrice > myMoney){
    console.log('Smashed potato and lentills soup');
}

/**
 * If chicken er price is less than my budget 
 * i wil eat chicken
 * naa hoi: else
 */
